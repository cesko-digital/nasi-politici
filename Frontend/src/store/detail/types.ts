...
interface LoadDetailAction {
	type: typeof LOAD_DETAIL;
}

export type DetailActionTypes = SetDetailAction | SetLoadingDetailEndAction | SetLoadingDetailStartAction |
	ToggleShowAllDonationsAction | ToggleShowAllRolesAction | LoadDetailAction;
